...
project = Project(package_name="compat",
...
rf"""
 Usage 
    echo on 
    cd C:\Users\Username\PycharmProjects\compatGit
...
project_urls = {
    'Homepage': 'https://github.com/SermetPekin/compat-repo',
    'Documentation': 'https://github.com/SermetPekin/compat-repo'
}
description = f"""
